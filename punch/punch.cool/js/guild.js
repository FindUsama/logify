...
$(function() {
    ...
    $('.j-show-modal').on('click', function(e) {
        e.preventDefault();
    ...
    // $('.j-request-candidates-form').each(function(){
    // 	$(this).validate({
    ...
    //              hideModal('#request-candidates');
    //              showModal('#request-candidate-confirmation');
    //          });
    //      }
    //  });
    // });
